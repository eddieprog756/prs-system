    ...
    <nav>
      <ul id="links">
        ...
        <!-- <div class="linkssss" id="studio" style="display:{{hidestudio}}">
            <li>
              <a href="workshop.php"
                ><i class="fa fa-building" aria-hidden="true"></i> Workshop</a
              >
            </li>
          </div> -->
      </ul>
  ...
  <div class="contents">
    ...
    <div class="containerr">
      <div class="hide">
        ...
        <label> <input type="checkbox" id="checkbox4" /> Client Paid </label>
      </div>
    ...
    <div class="bottombox">
      <div class="pr">
        ...
        <div class="acc">
          <label>
            <!--<input type="checkbox" id="checkbox2"> Project Done-->
            <input type="checkbox" id="checkbox2" /> Workshop Done
          </label>
        </div>
      </div>
    </div>
