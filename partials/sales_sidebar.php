<<<<<<<< HEAD:partials/sales_sidebar.php
<?php
// session_start();
  ...
  <div class="sidenav">
    ...
    <nav>
      <ul id="links">
        ...
        <?php endif; ?>
        <a href="./logout.php" class="text-secondary logout" style="margin-top:300px;"><i class="fa fa-sign-out-alt"></i> Log Out</a>
      </ul>
    </nav>
  </div>
...
>>>>>>>> refs/remotes/prs-system/main:partials/sidebar.php
</html>